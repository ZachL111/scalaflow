...
scalaflow is a Scala project for stream processing. It focuses on this technical goal: Implement typed stream windows, maps, and sink contracts.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 155, risk penalty 4, latency penalty 2, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
