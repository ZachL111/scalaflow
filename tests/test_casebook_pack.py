"""Regression checks for the scalaflow casebook."""
...
from casebook.harness import assert_expected, scalaflow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(scalaflow_summary(), assert_expected())
